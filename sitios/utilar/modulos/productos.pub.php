  ...
  <div class="container">
      ...
      <div class="box-productos row">
	      <div class="item col-md-10 col-md-offset-1">
		      <div class="imagen col-md-4"><a href="http://tramontinastore.com/" target="_blank"><img class="img-responsive" src="<?php echo _RUTA_WEB; ?>sitios/utilar/images/bg-pr-tramontina.png" alt="bg-pr-tramontina" /></a></div>
      ...
      <div class="box-productos row">
	      <div class="item col-md-10 col-md-offset-1">
		      <div class="imagen col-md-4"><a href="http://www.invictaonline.com.br/" target="_blank"><img class="img-responsive" src="<?php echo _RUTA_WEB; ?>sitios/utilar/images/bg-pr-invicta.png" alt="bg-pr-tramontina" /></a></div>
      ...
      <div class="box-productos row">
	      <div class="item col-md-10 col-md-offset-1">
		      <div class="imagen col-md-4"><a href="http://www.plasutil.com.br/plasutil/pt/index.php" target="_blank"><img class="img-responsive" src="<?php echo _RUTA_WEB; ?>sitios/utilar/images/bg-pr-plasutil.png" alt="bg-pr-tramontina" /></div>
       ...
       <div class="box-productos row">
	      <div class="item col-md-10 col-md-offset-1">
		      <div class="imagen col-md-4"><a href="http://www.porcelanaschmidt.com.br/schmidt/site/index.php" target="_blank"><img class="img-responsive" src="<?php echo _RUTA_WEB; ?>sitios/utilar/images/bg-pr-i.png" alt="bg-pr-tramontina" /></a></div>
